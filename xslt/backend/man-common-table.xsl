...
<!-- ********************************************************************
     $Id: man-common-table.xsl,v 1.1 2006/04/22 19:47:18 stevecheng Exp $
     ********************************************************************

     This file came from common/table.xsl in 
     the XSL DocBook Stylesheet distribution.

     It is not used by the first-stage DocBook-to-{Man,Texi}-XML processing, 
     but only in the second-stage processing, for implementing tables
     in man pages.
